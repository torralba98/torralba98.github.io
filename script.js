...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            ...
            break;
        case "help":
            sendTextMessage("<span class='sk'>Envía la <span class='bold'>'palabra'</span> correspondiente acerca de lo que quieras saber sobre mí 😝<br><br><span class='bold'>'about'</span> - más detalles sobre mí<br><span class='bold'>'experiencia'</span> - historial laboral<br><span class='bold'>'estudios'</span> - historial académico<br><span class='bold'>'meritos'</span> - logros académicos<br><span class='bold'>'idiomas'</span> - lenguas que hablo<br><span class='bold'>'colaboraciones'</span> - contribuciones realizadas con entidades<br><span class='bold'>'cursos'</span> - Webinars/cursos a los que asistí<br><span class='bold'>'cv'</span> - descarga de mi CV<br><span class='bold'>'enlaces'</span> - documentos de interés<br><span class='bold'>'contacto'</span> - Para poder hablar conmigo :D<br><span class='bold'>'clear'</span> - vaciar la conversación<br>");
            break;
        case "cv":
